              ...
              children: [
                Container(
                  ...
                  child: ListView.builder(
                    ...
                    physics: BouncingScrollPhysics(),
                    itemCount: (type == 'To Give'
                        ? (Hive.box<BooksGive>('booksgive').length == 0
                            ? 0
                            : Hive.box<BooksGive>('booksgive').length)
                        : (Hive.box<BooksRead>('booksread').length == 0
                            ? 0
                            : Hive.box<BooksRead>('booksread').length)),
                    itemBuilder: (BuildContext context, int idx) {
                      HiveObject? book = type == 'To Give'
                          ? Hive.box<BooksGive>('booksgive').getAt(idx)
                          : Hive.box<BooksRead>('booksread').getAt(idx);
                      String book_name = type == 'To Give'
                          ? Hive.box<BooksGive>('booksgive').getAt(idx)!.name
                          : Hive.box<BooksRead>('booksread').getAt(idx)!.name;
                      String author = type == 'To Give'
                          ? Hive.box<BooksGive>('booksgive').getAt(idx)!.author
                          : Hive.box<BooksRead>('booksread').getAt(idx)!.author;
                      String? image = type == 'To Give'
                          ? Hive.box<BooksGive>('booksgive').getAt(idx)?.image
                          : Hive.box<BooksRead>('booksread').getAt(idx)?.image;
